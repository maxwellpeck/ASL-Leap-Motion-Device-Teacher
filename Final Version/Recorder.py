...
class RECORDER:
    ...
    def Recreate_userData_Directory(self):
        path = os.getcwd() + "/Downloads/LeapDeveloperKit_2.3.1+31549_mac/LeapSDK/lib/Del 5/userData"
        shutil.rmtree(path)
        os.mkdir(path)
    ...
    def Save_Gesture(self):
        file_string = os.getcwd() + "/Downloads/LeapDeveloperKit_2.3.1+31549_mac/LeapSDK/lib/Del 5/userData/gesture" + str(self.fileIndex) + ".p"
        self.fileIndex += 1
